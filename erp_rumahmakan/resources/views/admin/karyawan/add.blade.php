...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <div class="col-lg-8">
      <form method="POST" action="add" class="mb-5" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          <label for="cabang" class="form-label @error('cabang') is-invalid @enderror">Cabang </label>
          <input type="text" class="form-control" id="cabang" name="cabang" value="{{ old('cabang') }}">
          @error('cabang')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="mb-3">
          <label for="hp" class="form-label @error('hp') is-invalid @enderror">No HP </label>
